...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    group: "ai",
    tagline: "Show up when people ask ChatGPT about you or your work.",
    eyebrow: "AI-powered",
    ...
    faqs: [
      ...
      {
        q: "Who is this for?",
        a: "Any professional — founders, consultants, job seekers, creators, freelancers, or anyone who wants to be found and recommended when people ask AI about their field.",
      },
    ],
  },
];

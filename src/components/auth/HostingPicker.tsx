        ...
        return (
          <button
            ...
            className={cn(
              ...
              active ? "border-cta ring-2 ring-cta/15" : "border-border",
            )}
          >
            <BrandMark name={host} className="h-7 w-7 shrink-0" />
            <span className="truncate">{host}</span>
            {active && (
              <span className="absolute right-2 top-2 flex h-4 w-4 items-center justify-center rounded-full bg-cta text-white">

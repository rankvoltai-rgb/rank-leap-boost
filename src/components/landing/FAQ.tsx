...
const FAQS = [
  ...
  { q: "Do I need SEO experience?", a: "Not at all. Rankvolt is built for business owners who want traffic without any SEO background or technical setup required. We handle keyword research, optimization, linking, and publishing so you can focus on your business." },
  { q: "Will this work for AI search too?", a: "Yes, absolutely. ChatGPT, Claude, and other AI tools pull answers from the web, so your site needs strong content listed first. Rankvolt publishes targeted articles that rank for keywords your customers search and ask about in AI chats every day." },
  ...
  { q: "What if I'm not sure it's right for me?", a: "Sign up with full access and generate real articles for your website today. Review the quality, test the full workflow, and see if Rankvolt fits how you work. Cancel anytime from billing settings if it's not the right fit." },
];

...
export const FAQS = [
  ...
  { q: "How do articles get published?", a: "Rankbox connects to WordPress, Webflow, Shopify, Wix, and more for one-click publishing. Flip on auto-publish and new articles go live on your schedule. On any other platform, copy the formatted content straight from the editor." },
      ...
      <div className="mx-auto max-w-3xl px-5">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-balance text-lg text-muted-foreground">
            Everything you need to know about pricing, features, and how Rankbox helps you rank on
